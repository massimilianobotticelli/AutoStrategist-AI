...
# We capture the authentication context here on the Driver.
# These variables will be "closed over" (pickled) and sent to the Worker nodes
# where the UDF actually runs.

# 1. Try Environment Variables (Best for Scripts / Databricks Connect)
db_host = os.environ.get("DATABRICKS_HOST")
db_token = os.environ.get("DATABRICKS_TOKEN")

# 2. Fallback to Notebook Context (Best for Interactive Notebooks)
...
# Instantiate the UDF with the captured credentials
